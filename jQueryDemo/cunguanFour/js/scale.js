	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			var imgList   = document.querySelectorAll(params.elem + " img"),
				...
				zoomImgClick   = document.querySelector("#showImg"),
      	...
      	rightBtn.style.display = "none";
			...
			for(var len=imgList.length,i=0; i<len; i++){
				imgList[i].addEventListener("click", function(){
					...
					zoomImg.src = imgSrc;
					// 添加
var imgArr = ['img/dealOne.jpg','img/dealTwo.jpg','img/dealThree.jpg'];
      var indexNum = imgArr.indexOf(zoomImg.getAttribute("src"));
